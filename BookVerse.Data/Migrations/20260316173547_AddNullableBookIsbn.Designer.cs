...
namespace BookVerse.Data.Migrations
{
    ...
    [Migration("20260316173547_AddNullableBookIsbn")]
    partial class AddNullableBookIsbn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookVerse.DataModels.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GenreId = 1,
                            IsDeleted = false,
                            PublishedOn = new DateOnly(2026, 3, 16),
            ...
            modelBuilder.Entity("BookVerse.DataModels.Genre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookVerse.DataModels.UserBook", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b1f28f01-0a6f-4ec3-b765-fe3ccc3c396b",
                            Email = "admin@bookverse.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@BOOKVERSE.COM",
                            NormalizedUserName = "ADMIN@BOOKVERSE.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEEMdKv4QZi2OCT3gF2VJ4aZG7Qbcv8WRTS1wc7WbRGhjzUwhmqcrSj1mLJwIYBzMyA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "490382d7-2428-40c4-a575-3fd0be1ef0ae",
            ...
            modelBuilder.Entity("BookVerse.DataModels.Book", b =>
                {
                    b.HasOne("BookVerse.DataModels.Genre", "Genre")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookVerse.DataModels.UserBook", b =>
                {
                    b.HasOne("BookVerse.DataModels.Book", "Book")
                        .WithMany("UsersBooks")
